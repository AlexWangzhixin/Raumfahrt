...
def run_perception_experiment(config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    pipeline_cfg["experiment_name"] = "perception"
    pipeline_cfg["inputs"] = {"environment_artifact": env_artifact}

    result = extract_features(pipeline_cfg)
