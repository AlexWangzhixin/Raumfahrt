#!/usr/bin/env python3
"""
Run Chapter 4 dynamics experiment.
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run Chapter 4 dynamics experiment.")
    parser.add_argument(
        "--config",
        default=os.path.join("configs", "ch4_dynamics.yaml"),
