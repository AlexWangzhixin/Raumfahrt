#!/usr/bin/env python3
"""
Run perception feature extraction experiment.
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run perception feature extraction experiment.")
    parser.add_argument(
        "--config",
        default=os.path.join("configs", "perception.yaml"),
